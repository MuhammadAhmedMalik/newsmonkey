...
export class News extends Component {
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=9e2f112ff9924702ade1c8c4c94c9046&page=1&pageSize=${this.state.pageSize}`;
    ...
    handlePrevClick = async ()=>{
        let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=9e2f112ff9924702ade1c8c4c94c9046&page=${this.state.page - 1}&pageSize=${this.state.pageSize}`;
        this.setState({loading: true});
        let data = await fetch(url);
        let parsedData = await data.json();
        this.setState({
